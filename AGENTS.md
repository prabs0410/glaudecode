...
**GlaudeCode** — the Claude Code Companion CLI. A meta-layer above Claude Code that handles multi-session orchestration, cross-session memory, mobile/web control, and CLI-level lifecycle hooks.
